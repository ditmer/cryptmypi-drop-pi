...
OPTIONS:
    ...
    --force-all -stages         Executes stage 1, 2, and 3 without confirmation
    --skip-stage1, --no-rebuild Skips stage 1 (if a previous build exists)
    --skip-stage2,              Skips stage 2
        ...
        do
            $_STAGE1_CONFIRM && {
                ...
                $_STAGE1_REBUILD && {
                    ...
                    $_SKIP_STAGE_2 && _CONTINUE='A3000123401235823648928314689745' || _CONTINUE='n'
                }
            }
            ...
            case "${_CONTINUE}" in
                ...
                'n')
                    ...
                    break;
                    ;;
                'A3000123401235823648928314689745')
                    execute "stage3"
                    break;
                    ;;
                *)
...
echo "Goodbye from cryptmypi - Drop-pi edition (${_VER})."
exit 0
